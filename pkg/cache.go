...
/*
RetrieveAll4 Retrieve Cache Types
Returns the list of caches.  Example Requests:  caches
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []GetCachesResponse
*/
func (a *CacheApiService) RetrieveAll4(ctx _context.Context) ([]models.GetCachesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetCachesResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/caches"
...
/*
SwitchCache Switch Cache
Switches the cache to chosen one.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param putCachesRequest
@return PutCachesResponse
*/
func (a *CacheApiService) SwitchCache(ctx _context.Context, putCachesRequest models.PutCachesRequest) (models.PutCachesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutCachesResponse
	)
