...
// MixTaxonomyApiService MixTaxonomyApi service
type MixTaxonomyApiService service

/*
RetrieveAll14 Method for RetrieveAll14
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return string
*/
func (a *MixTaxonomyApiService) RetrieveAll14(ctx _context.Context) (string, *_nethttp.Response, error) {
	var (
	...
	path := a.client.cfg.BasePath + "/mixtaxonomy"
