...
// EntityFieldConfigurationApiService EntityFieldConfigurationApi service
type EntityFieldConfigurationApiService service

/*
GetAddresses Retrieves the Entity Field Configuration
It retrieves all the Entity Field Configuration
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entity entity
@return []GetFieldConfigurationEntityResponse
*/
func (a *EntityFieldConfigurationApiService) GetAddresses(ctx _context.Context, entity string) ([]models.GetFieldConfigurationEntityResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetFieldConfigurationEntityResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/fieldconfiguration/{entity}"
