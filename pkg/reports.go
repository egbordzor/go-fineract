...
*/
func (a *ReportsApiService) CreateReport(ctx _context.Context, postRepostRequest models.PostRepostRequest) (models.PostReportsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostReportsResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/reports"
...
*/
func (a *ReportsApiService) DeleteReport(ctx _context.Context, id int64) (models.DeleteReportsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.DeleteReportsResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/reports/{id}"
...
/*
RetrieveOfficeTemplate Retrieve Report Template
...
*/
func (a *ReportsApiService) RetrieveOfficeTemplate(ctx _context.Context) (models.GetReportsTemplateResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetReportsTemplateResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/reports/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
...
*/
func (a *ReportsApiService) RetrieveReport(ctx _context.Context, id int64) (models.GetReportsResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  models.GetReportsResponse
	)
...
/*
RetrieveReportList List Reports
Lists all reports and their parameters.  Example Request:  reports
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []GetReportsResponse
*/
func (a *ReportsApiService) RetrieveReportList(ctx _context.Context) ([]models.GetReportsResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
...
*/
func (a *ReportsApiService) UpdateReport(ctx _context.Context, id int64, putReportRequest models.PutReportRequest) (models.PutReportResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutReportResponse
	)
