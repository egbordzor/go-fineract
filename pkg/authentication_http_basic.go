...
// AuthenticationHTTPBasicApiService AuthenticationHTTPBasicApi service
type AuthenticationHTTPBasicApiService service

// AuthenticateOpts Optional parameters for the method 'Authenticate'
 ...
 * @param optional nil or *AuthenticateOpts - Optional Parameters:
 * @param "Body" (optional.String) -
@return PostAuthenticationResponse
*/
func (a *AuthenticationHTTPBasicApiService) Authenticate(ctx _context.Context, opts *AuthenticateOpts) (models.PostAuthenticationResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostAuthenticationResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/authentication"
