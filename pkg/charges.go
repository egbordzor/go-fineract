...
/*
CreateCharge Create/Define a Charge
...
*/
func (a *ChargesApiService) CreateCharge(ctx _context.Context, postChargesRequest models.PostChargesRequest) (models.PostChargesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostChargesResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/charges"
...
*/
func (a *ChargesApiService) DeleteCharge(ctx _context.Context, chargeId int64) (models.DeleteChargesChargeIdResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.DeleteChargesChargeIdResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/charges/{chargeId}"
...
/*
RetrieveAllCharges Retrieve Charges
Returns the list of defined charges.  Example Requests:  charges
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []GetChargesResponse
*/
func (a *ChargesApiService) RetrieveAllCharges(ctx _context.Context) ([]models.GetChargesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetChargesResponse
	)
...
@return GetChargesResponse
*/
func (a *ChargesApiService) RetrieveCharge(ctx _context.Context, chargeId int64) (models.GetChargesResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
...
/*
RetrieveNewChargeDetails Retrieve Charge Template
...
*/
func (a *ChargesApiService) RetrieveNewChargeDetails(ctx _context.Context) (models.GetChargesTemplateResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  models.GetChargesTemplateResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/charges/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
...
*/
func (a *ChargesApiService) UpdateCharge(ctx _context.Context, chargeId int64, putChargesChargeIdRequest models.PutChargesChargeIdRequest) (models.PutChargesChargeIdResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutChargesChargeIdResponse
	)
	...
	// body params
	postBody = &putChargesChargeIdRequest
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
