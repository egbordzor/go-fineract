...
// RunReportsApiService RunReportsApi service
type RunReportsApiService service

// RunReportOpts Optional parameters for the method 'RunReport'
type RunReportOpts struct {
	IsSelfServiceUserReport optional.Bool
}
 ...
 * @param optional nil or *RunReportOpts - Optional Parameters:
 * @param "IsSelfServiceUserReport" (optional.Bool) -  isSelfServiceUserReport
@return GetReportNameResponse
*/
func (a *RunReportsApiService) RunReport(ctx _context.Context, reportName string, opts *RunReportOpts) (models.GetReportNameResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetReportNameResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/runreports/{reportName}"
	...
	if opts != nil && opts.IsSelfServiceUserReport.IsSet() {
		queryParams.Add("isSelfServiceUserReport", parameterToString(opts.IsSelfServiceUserReport.Value(), ""))
	}
