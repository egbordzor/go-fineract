...
// SelfShareAccountsApiService SelfShareAccountsApi service
type SelfShareAccountsApiService service

// CreateAccount1Opts Optional parameters for the method 'CreateAccount1'
type CreateAccount1Opts struct {
	Body optional.String
}

/*
CreateAccount1 Submit new share application
 ...
 * @param optional nil or *CreateAccount1Opts - Optional Parameters:
 * @param "Body" (optional.String) -
@return []PostNewShareApplicationResponse
*/
func (a *SelfShareAccountsApiService) CreateAccount1(ctx _context.Context, opts *CreateAccount1Opts) ([]models.PostNewShareApplicationResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.PostNewShareApplicationResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/self/shareaccounts"
...
/*
RetrieveShareAccount Retrieve a share application/account
   Example Requests:  self/shareaccounts/12
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
@return string
*/
func (a *SelfShareAccountsApiService) RetrieveShareAccount(ctx _context.Context, accountId int64) (string, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	path := a.client.cfg.BasePath + "/self/shareaccounts/{accountId}"
...
// Template19Opts Optional parameters for the method 'Template19'
type Template19Opts struct {
	ClientId  optional.Int64
	ProductId optional.Int64
}

/*
Template19 Retrieve Share Account Template
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *Template19Opts - Optional Parameters:
 * @param "ClientId" (optional.Int64) -
 * @param "ProductId" (optional.Int64) -
@return []GetShareAccountsClientIdProductIdResponse
*/
func (a *SelfShareAccountsApiService) Template19(ctx _context.Context, opts *Template19Opts) ([]models.GetShareAccountsClientIdProductIdResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetShareAccountsClientIdProductIdResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/self/shareaccounts/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
