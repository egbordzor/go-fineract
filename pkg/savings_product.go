...
// SavingsProductApiService SavingsProductApi service
type SavingsProductApiService service

/*
Create12 Create a Savings Product
...
*/
func (a *SavingsProductApiService) Create12(ctx _context.Context, postSavingsProductsRequest models.PostSavingsProductsRequest) (models.PostSavingsProductsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostSavingsProductsResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/savingsproducts"
	...
	// body params
	postBody = &postSavingsProductsRequest
	if ctx != nil {
...
/*
Delete19 Delete a Savings Product
Deletes a Savings Product
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param productId productId
@return DeleteSavingsProductsProductIdResponse
*/
func (a *SavingsProductApiService) Delete19(ctx _context.Context, productId int64) (models.DeleteSavingsProductsProductIdResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.DeleteSavingsProductsProductIdResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/savingsproducts/{productId}"
...
/*
RetrieveAll33 List Savings Products
Lists Savings Products  Example Requests:  savingsproducts  savingsproducts?fields&#x3D;name
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []GetSavingsProductsResponse
*/
func (a *SavingsProductApiService) RetrieveAll33(ctx _context.Context) ([]models.GetSavingsProductsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetSavingsProductsResponse
	)
...
/*
RetrieveOne24 Retrieve a Savings Product
...
*/
func (a *SavingsProductApiService) RetrieveOne24(ctx _context.Context, productId int64) (models.GetSavingsProductsProductIdResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  models.GetSavingsProductsProductIdResponse
	)
...
/*
RetrieveTemplate19 Retrieve Savings Product Template
...
*/
func (a *SavingsProductApiService) RetrieveTemplate19(ctx _context.Context) (models.GetSavingsProductsTemplateResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  models.GetSavingsProductsTemplateResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/savingsproducts/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
...
/*
Update19 Update a Savings Product
...
*/
func (a *SavingsProductApiService) Update19(ctx _context.Context, productId int64, putSavingsProductsProductIdRequest models.PutSavingsProductsProductIdRequest) (models.PutSavingsProductsProductIdResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutSavingsProductsProductIdResponse
	)
	...
	// body params
	postBody = &putSavingsProductsProductIdRequest
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
