...
// SelfUserApiService SelfUserApi service
type SelfUserApiService service

/*
Update21 Update User
...
*/
func (a *SelfUserApiService) Update21(ctx _context.Context, putSelfUserRequest models.PutSelfUserRequest) (models.PutSelfUserResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutSelfUserResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/self/user"
