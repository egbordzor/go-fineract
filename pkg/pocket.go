...
// PocketApiService PocketApi service
type PocketApiService service

// HandleCommands7Opts Optional parameters for the method 'HandleCommands7'
type HandleCommands7Opts struct {
	Command optional.String
	Body    optional.String
}

/*
HandleCommands7 Link/delink accounts to/from pocket
 ...
 * @param optional nil or *HandleCommands7Opts - Optional Parameters:
 * @param "Command" (optional.String) -  command
 * @param "Body" (optional.String) -
@return PostLinkDelinkAccountsToFromPocketResponse
*/
func (a *PocketApiService) HandleCommands7(ctx _context.Context, opts *HandleCommands7Opts) (models.PostLinkDelinkAccountsToFromPocketResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostLinkDelinkAccountsToFromPocketResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/self/pockets"
...
/*
RetrieveAll36 Retrieve accounts linked to pocket
All linked loan  Example Requests:   self/pockets
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return GetAccountsLinkedToPocketResponse
*/
func (a *PocketApiService) RetrieveAll36(ctx _context.Context) (models.GetAccountsLinkedToPocketResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetAccountsLinkedToPocketResponse
	)
