...
// ChangeSchedulerStatusOpts Optional parameters for the method 'ChangeSchedulerStatus'
type ChangeSchedulerStatusOpts struct {
	Command optional.String
}

/*
ChangeSchedulerStatus Activate Scheduler Jobs | Suspend Scheduler Jobs
Activates the scheduler job service. | Suspends the scheduler job service.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ChangeSchedulerStatusOpts - Optional Parameters:
 * @param "Command" (optional.String) -  command
*/
func (a *SchedulerApiService) ChangeSchedulerStatus(ctx _context.Context, opts *ChangeSchedulerStatusOpts) (*_nethttp.Response, error) {
	var (
	...
	path := a.client.cfg.BasePath + "/scheduler"
...
/*
RetrieveStatus Retrieve Scheduler Status
Returns the scheduler status.  Example Requests:  scheduler
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return GetSchedulerResponse
*/
func (a *SchedulerApiService) RetrieveStatus(ctx _context.Context) (models.GetSchedulerResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetSchedulerResponse
	)
