...
/*
RetrieveCurrencies Retrieve Currency Configuration
...
*/
func (a *CurrencyApiService) RetrieveCurrencies(ctx _context.Context) (models.GetCurrenciesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetCurrenciesResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/currencies"
...
*/
func (a *CurrencyApiService) UpdateCurrencies(ctx _context.Context, putCurrenciesRequest models.PutCurrenciesRequest) (models.PutCurrenciesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutCurrenciesResponse
	)
