...
*/
func (a *CodesApiService) CreateCode(ctx _context.Context, postCodesRequest models.PostCodesRequest) (models.PostCodesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostCodesResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/codes"
...
*/
func (a *CodesApiService) DeleteCode(ctx _context.Context, codeId int64) (models.DeleteCodesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.DeleteCodesResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/codes/{codeId}"
...
/*
RetrieveCode Retrieve a Code
Returns the details of a Code.  Example Requests:  codes/1
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param codeId codeId
@return GetCodesResponse
*/
func (a *CodesApiService) RetrieveCode(ctx _context.Context, codeId int64) (models.GetCodesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetCodesResponse
	)
...
/*
RetrieveCodes Retrieve Codes
Returns the list of codes.  Example Requests:  codes
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []GetCodesResponse
*/
func (a *CodesApiService) RetrieveCodes(ctx _context.Context) ([]models.GetCodesResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
...
*/
func (a *CodesApiService) UpdateCode(ctx _context.Context, codeId int64, putCodesRequest models.PutCodesRequest) (models.PutCodesResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutCodesResponse
	)
