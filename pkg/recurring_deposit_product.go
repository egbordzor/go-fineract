...
// RecurringDepositProductApiService RecurringDepositProductApi service
type RecurringDepositProductApiService service

/*
Create11 Create a Recurring Deposit Product
...
*/
func (a *RecurringDepositProductApiService) Create11(ctx _context.Context, postRecurringDepositProductsRequest models.PostRecurringDepositProductsRequest) (models.PostRecurringDepositProductsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostRecurringDepositProductsResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/recurringdepositproducts"
	...
	// body params
	postBody = &postRecurringDepositProductsRequest
	if ctx != nil {
...
/*
Delete17 Delete a Recurring Deposit Product
Deletes a Recurring Deposit Product
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param productId productId
@return DeleteRecurringDepositProductsProductIdResponse
*/
func (a *RecurringDepositProductApiService) Delete17(ctx _context.Context, productId int64) (models.DeleteRecurringDepositProductsProductIdResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.DeleteRecurringDepositProductsProductIdResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/recurringdepositproducts/{productId}"
...
/*
RetrieveAll31 List Recuring Deposit Products
...
*/
func (a *RecurringDepositProductApiService) RetrieveAll31(ctx _context.Context) ([]models.GetRecurringDepositProductsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetRecurringDepositProductsResponse
	)
...
/*
RetrieveOne21 Retrieve a Recurring Deposit Product
...
*/
func (a *RecurringDepositProductApiService) RetrieveOne21(ctx _context.Context, productId int64) (models.GetRecurringDepositProductsProductIdResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  models.GetRecurringDepositProductsProductIdResponse
	)
...
/*
RetrieveTemplate16 Method for RetrieveTemplate16
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return string
*/
func (a *RecurringDepositProductApiService) RetrieveTemplate16(ctx _context.Context) (string, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
	...
	// create path and map variables
	path := a.client.cfg.BasePath + "/recurringdepositproducts/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
...
/*
Update17 Update a Recurring Deposit Product
...
*/
func (a *RecurringDepositProductApiService) Update17(ctx _context.Context, productId int64, putRecurringDepositProductsRequest models.PutRecurringDepositProductsRequest) (models.PutRecurringDepositProductsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutRecurringDepositProductsResponse
	)
	...
	// body params
	postBody = &putRecurringDepositProductsRequest
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
