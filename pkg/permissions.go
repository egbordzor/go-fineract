...
/*
RetrieveAllPermissions List Application Permissions
...
*/
func (a *PermissionsApiService) RetrieveAllPermissions(ctx _context.Context) ([]models.GetPermissionsResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  []models.GetPermissionsResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/permissions"
...
/*
UpdatePermissionsDetails Enable/Disable Permissions for Maker Checker
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param putPermissionsRequest
@return CommandProcessingResult
*/
func (a *PermissionsApiService) UpdatePermissionsDetails(ctx _context.Context, putPermissionsRequest models.PutPermissionsRequest) (models.CommandProcessingResult, *_nethttp.Response, error) {
	var (
	...
	// body params
	postBody = &putPermissionsRequest
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
