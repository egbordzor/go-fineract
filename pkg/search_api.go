...
/*
AdvancedSearch Adhoc query search
...
*/
func (a *SearchAPIApiService) AdvancedSearch(ctx _context.Context, postAdhocQuerySearchRequest models.PostAdhocQuerySearchRequest) (models.PostAdhocQuerySearchResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostAdhocQuerySearchResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/search/advance"
	...
	// body params
	postBody = &postAdhocQuerySearchRequest
	if ctx != nil {
...
/*
RetrieveAdHocSearchQueryTemplate Retrive Adhoc Search query template
Mandatory Fields  search?query&#x3D;000000001
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return GetSearchResponse
*/
func (a *SearchAPIApiService) RetrieveAdHocSearchQueryTemplate(ctx _context.Context) (models.GetSearchResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetSearchResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/search/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
...
// SearchDataOpts Optional parameters for the method 'SearchData'
type SearchDataOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SearchDataOpts - Optional Parameters:
 * @param "Query" (optional.String) -  query
 * @param "Resource" (optional.String) -  resource
 * @param "ExactMatch" (optional.Bool) -  exactMatch
@return GetSearchResponse
*/
func (a *SearchAPIApiService) SearchData(ctx _context.Context, opts *SearchDataOpts) (models.GetSearchResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
	...
	// create path and map variables
	path := a.client.cfg.BasePath + "/search"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
	...
	if opts != nil && opts.Resource.IsSet() {
		queryParams.Add("resource", parameterToString(opts.Resource.Value(), ""))
	}
	if opts != nil && opts.ExactMatch.IsSet() {
		queryParams.Add("exactMatch", parameterToString(opts.ExactMatch.Value(), ""))
	}
	// to determine the Content-Type header
	contentTypes := []string{}
