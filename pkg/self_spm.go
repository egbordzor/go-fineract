...
@return []SurveyData
*/
func (a *SelfSpmApiService) FetchAllSurveys(ctx _context.Context) ([]models.SurveyData, *_nethttp.Response, error) {
	var (
	...
	path := a.client.cfg.BasePath + "/self/surveys"
