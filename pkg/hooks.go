...
*/
func (a *HooksApiService) CreateHook(ctx _context.Context, postHookRequest models.PostHookRequest) (models.PostHookResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PostHookResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/hooks"
...
*/
func (a *HooksApiService) DeleteHook(ctx _context.Context, hookId int64) (models.DeleteHookResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.DeleteHookResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/hooks/{hookId}"
	path = strings.Replace(path, "{"+"hookId"+"}", _neturl.QueryEscape(parameterToString(hookId, "")), -1)
...
/*
RetrieveHook Retrieve a Hook
Returns the details of a Hook.  Example Requests:  hooks/1
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hookId hookId
@return GetHookResponse
*/
func (a *HooksApiService) RetrieveHook(ctx _context.Context, hookId int64) (models.GetHookResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.GetHookResponse
	)
...
/*
RetrieveHooks Retrieve Hooks
Returns the list of hooks.  Example Requests:  hooks
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []GetHookResponse
*/
func (a *HooksApiService) RetrieveHooks(ctx _context.Context) ([]models.GetHookResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
...
/*
Template3 Retrieve Hooks Template
...
*/
func (a *HooksApiService) Template3(ctx _context.Context) (models.GetHookTemplateResponse, *_nethttp.Response, error) {
	var (
		httpMethod   = _nethttp.MethodGet
		postBody     interface{}
		formFileName string
		fileName     string
		fileBytes    []byte
		returnValue  models.GetHookTemplateResponse
	)

	// create path and map variables
	path := a.client.cfg.BasePath + "/hooks/template"
	headerParams := make(map[string]string)
	queryParams := _neturl.Values{}
	formParams := _neturl.Values{}
...
*/
func (a *HooksApiService) UpdateHook(ctx _context.Context, hookId int64, putHookRequest models.PutHookRequest) (models.PutHookResponse, *_nethttp.Response, error) {
	var (
		...
		fileName     string
		fileBytes    []byte
		returnValue  models.PutHookResponse
	)
